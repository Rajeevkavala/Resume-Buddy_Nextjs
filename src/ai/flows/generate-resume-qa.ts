...
const GenerateResumeQAOutputSchema = z.object({
  qaPairs: z
    .array(QAPairSchema)
    .describe('An array of 5 intelligent question and answer pairs relevant to the resume and topic.'),
});
...
const prompt = ai.definePrompt({
  ...
  prompt: `You are an expert AI interview coach. Your task is to generate 5 insightful, context-aware question-and-answer pairs based on the provided resume and a specific topic. Use a Retrieval-Augmented Generation (RAG) approach to ensure your output is deeply rooted in the resume's content.
...
Follow these steps for each of the 5 Q&A pairs:
