        ...
        <CardHeader>
          <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between">
            <div>
              ...
              <CardDescription>
                Upload your resume, select your target role, add job details, and save your data for AI analysis.
              </CardDescription>
            </div>
            {(resumeText || jobDescription || jobRole || jobUrl) && (
               <div className="flex gap-2 mt-4 sm:mt-0">{/* Action buttons will be inserted here */}
